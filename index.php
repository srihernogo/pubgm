...
<center>
<div class="alert">
Welcome to PUBG MOBILE x BLACKPINK event
...
<div class="balance-detail">Additional reward for Blackpink event</div>
...
<button type="button" class="btn-anjir" onmousedown="buka.play()" onclick="account_login()" class="next">Collect</button>
</div>
</div>

<div class="popup account_login" style="display: none;">
<div class="popup-box animated fadeInDown">
<a onclick="close_account_login()" onmousedown="tutup.play()" class="close"><i class="zmdi zmdi-close-circle"></i></a>
...
<br>
<br>
<button type="button" class="btn-anjir" onmousedown="tutup.play()" onclick="close_account_login()">Back</button>
</div>
</div>
